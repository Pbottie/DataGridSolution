...
public static class BogusData
{
    ...
    public static List<SearchMeasurementListItem> GetData()
    {
        List<SearchMeasurementListItem> bogusList = new();
        ...
        var testImpressions = new Faker<StatisticInfo>()
            ...
            .RuleFor(s => s.Count, f => f.Random.Double(1, 50000))
            .RuleFor(s => s.Recently, (f, s) => f.Random.Double(0, s.Count));
        ...
        bogusList = testData.Generate(8).ToList();
        return bogusList;
    }
